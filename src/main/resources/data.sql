...
VALUES ('admin', 1),  -- Assigning ROLE_ADMIN to user john_doe
       ('ramesh', 2), -- Assigning ROLE_USER to user jane_smith
       ('mike_wilson', 3); -- Assigning ROLE_TEACHER to user mike_wilson
...
VALUES ('Great news! Looking forward to it.', '2024-03-18 08:30:00', 'john_doe', 1),
       ('I have some suggestions for improvement.', '2024-03-19 09:00:00', 'jane_smith', 2),
...
VALUES (1, 'Assignment 1', 'Complete the assigned tasks.', 1024, 80, 'HW001', <binary_data>),
       (2, 'Project Submission', 'Submit your project by the deadline.', 2048, 90, 'HW002', <binary_data>),
       (3, 'Research Paper', 'Write a research paper on the given topic.', 4096, 85, 'HW003', <binary_data>);


INSERT INTO user_classroom (username, classroom_id)
VALUES ('ramesh', 1),  -- Assigning classroom Mathematics to user john_doe
       ('mike_wilson', 3); -- Assigning classroom Science to user mike_wilson


INSERT INTO news_user (news_id, username)
VALUES (1, 'ramesh'),  -- Assigning news ID 1 to user john_doe
       (3, 'mike_wilson'); -- Assigning news ID 3 to user mike_wilson

INSERT INTO user_homework (username, homework_id)
VALUES ('ramesh', 1),  -- Assigning homework ID 1 to user john_doe
       ('mike_wilson', 3); -- Assigning homework ID 3 to user mike_wilson
